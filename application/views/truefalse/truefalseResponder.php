    ...
    <div>
        ...
        */
        ...
        <?php while (isset($truefalse['frase' . $i])) { ?>
            ...
            <label
                    for=<?php echo "resposta1[" . $i . "]"; ?>><?= $i / 2 == 0 ? $truefalse['frase' . $i][$j]['opcaoTrue'] : $truefalse['frase' . $i][$j]['opcaoFalse']; ?></label>
            <br>
            ...
            <label
                    for=<?php echo "resposta2[" . $i . "]"; ?>><?= $i / 2 == 0 ? $truefalse['frase' . $i][$j]['opcaoFalse'] : $truefalse['frase' . $i][$j]['opcaoTrue']; ?></label>
            <br>
