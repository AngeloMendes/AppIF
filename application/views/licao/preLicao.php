    ...
    <div class="form-group ">
        ...
        <div style="margin-top:5%" align="center" class="col-xs-12 col-sm-10 col-md-8 col-md-offset-2">
            ...
            <a href="<?php echo site_url('pergunta/recomecar/' . $licao['idLicao']) ?>"
               ...
               class="btn btn-primary btn-lg active" role="button">Iniciar</a>
            <?php } else{?>
                <p><?php echo $msg_refazer?></p>
                <a href="<?php echo site_url('licao/limparProgresso/'. $licao['idLicao']) ?>"

               class="btn btn-primary btn-lg active" role="button">Refazer</a>
                <a href="<?php echo site_url('licao/index') ?>"

                   class="btn btn-primary btn-lg active" role="button">Voltar</a>
            <?php }?>
        </div>
    </div>
</div>
