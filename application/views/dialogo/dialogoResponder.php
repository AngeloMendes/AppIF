...
<?php echo form_open('resposta/addDialogo', array("class" => "form-horizontal")); ?>
    ...
    */
    ...
    <?php while (isset($dialogo['frase'.$i])) { ?>
        ...
        <label style="margin: 1% 1% 1% 1%" class="btn btn-success col-xs-12 col-sm-10 col-md-5  col-sm-offset-2 col-md-offset-1" for=<?php echo "resposta1[".$i."]"; ?>><?php echo $dialogo['frase'.$i][$j]['opcao1']; ?>
            <input type="radio" name=<?php echo "resposta".$i; ?> id=<?php echo "resposta1[".$i."]"; ?> value="<?php echo $dialogo['frase'.$i][$j]['opcao1']; ?>">
        </label>
        <label style="margin: 1% 1% 1% 1%" class="btn btn-info col-xs-12 col-sm-10 col-md-5 col-sm-offset-2 col-md-offset-1" for=<?php echo "resposta2[".$i."]"; ?>><?php echo $dialogo['frase'.$i][$j]['opcao2']; ?>
            <input type="radio" name=<?php echo "resposta".$i; ?> id=<?php echo "resposta2[".$i."]"; ?> value="<?php echo $dialogo['frase'.$i][$j]['opcao2']; ?>">
        </label>
        <label style="margin: 1% 1% 1% 1%" class="btn btn-warning col-xs-12 col-sm-10 col-md-5 col-sm-offset-2 col-md-offset-1" for=<?php echo "resposta3[".$i."]"; ?>><?php echo $dialogo['frase'.$i][$j]['opcao3']; ?>
            <input type="radio" name=<?php echo "resposta".$i; ?> id=<?php echo "resposta3[".$i."]"; ?> value="<?php echo $dialogo['frase'.$i][$j]['opcao3']; ?>">
        </label>
